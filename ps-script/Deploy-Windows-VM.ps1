################ can possibly make do without this if can make the module as a single ps1 script
################ save on passing ina nd out variables and make for a cleaner "master" run code
################ will require significant restructure of how code currently is run
